...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
  ...
  <div class="site-wrap">
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-9 d-none d-lg-block">
            <a href="#" class="small mr-3"><span class="icon-question-circle-o mr-2"></span> Welcome to Physics Academy</a> 
            <a href="#" class="small mr-3"><span class="icon-phone2 mr-2"></span> 077-123-45-67</a> 
            <a href="#" class="small mr-3"><span class="icon-envelope-o mr-2"></span> info@mydomain.com</a> 
          </div>
          <div class="col-lg-3 text-right">
            
            <a href="#" class="btn btn-secondary px-4 py-2 rounded-0"><span class="icon-user"></span> <?php echo $_SESSION['user_name']; ?></a>
    ...
    <div class="hero-slide owl-carousel site-blocks-cover">
      ...
      <div class="intro-section" style="background-image: url('images/wall2.jpg');">
        <div class="container">
          <div class="row align-items-center">
            <div class="col-lg-12 mx-auto text-center" data-aos="fade-up">
              <h1>Enjoy the Physics Around You</h1>
            </div>
          </div>
        </div>
      </div>
              ...
              <div class="owl-slide-3 owl-carousel">
                  <div class="course-1-item">
                    <figure class="thumnail">
                      ...
                      <div class="category"><h3>Lesson - 2021/11/24</h3></div>  
                    </figure>
                    <div class="course-1-content pb-4">
                      ...
                      <p><a href="course-single.html" class="btn btn-primary rounded-0 px-4">Get Notes</a></p>
                    </div>
                  </div>
                  ...
                  <div class="course-1-item">
                    <figure class="thumnail">
                      ...
                      <div class="category"><h3>Lesson - 2021/12/28</h3></div>  
                    </figure>
                    <div class="course-1-content pb-4">
                      <h2>How To Create Mobile Apps Using Ionic</h2>
                      <div class="rating text-center mb-3">
                      ...
                      <p class="desc mb-4">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Similique accusantium ipsam.</p>
                      <p><a href="course-single.php" class="btn btn-primary rounded-0 px-4">Get Notes</a></p>
                    </div>
                  </div>
                  ...
                  <div class="course-1-item">
                    <figure class="thumnail">
                      ...
                      <div class="category"><h3>Lesson - 2021/12/12</h3></div>  
                    </figure>
                    <div class="course-1-content pb-4">
                      <h2>How To Create Mobile Apps Using Ionic</h2>
                      <div class="rating text-center mb-3">
                      ...
                      <p class="desc mb-4">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Similique accusantium ipsam.</p>
                      <p><a href="courses-single.php" class="btn btn-primary rounded-0 px-4">Get Notes</a></p>
                    </div>
                  </div>
                  ...
                  <div class="course-1-item">
                    <figure class="thumnail">
                      ...
                      <div class="category"><h3>Lesson - 2021/11/30</h3></div>  
                    </figure>
                    <div class="course-1-content pb-4">
                      <h2>How To Create Mobile Apps Using Ionic</h2>
                      <div class="rating text-center mb-3">
                  ...
                  <div class="course-1-item">
                    <figure class="thumnail">
                      ...
                      <div class="category"><h3>Lesson - 2021/11/23</h3></div>  
                    </figure>
                    <div class="course-1-content pb-4">
                      <h2>How To Create Mobile Apps Using Ionic</h2>
                      <div class="rating text-center mb-3">
                  ...
                  <div class="course-1-item">
                    <figure class="thumnail">
                      ...
                      <div class="category"><h3>Lesson - 2021/11/14</h3></div>  
                    </figure>
                    <div class="course-1-content pb-4">
                      <h2>How To Create Mobile Apps Using Ionic</h2>
                      <div class="rating text-center mb-3">
